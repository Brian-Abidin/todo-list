...
function addValues() {
  ...
  console.log(taskValue, descriptionValue, urgency, dateValue, newTime, tagValue);
  if (_domElements__WEBPACK_IMPORTED_MODULE_0__.btnSubmit.type === "submit") {
    (0,_createProject__WEBPACK_IMPORTED_MODULE_1__["default"])(taskValue, descriptionValue, urgency, dateValue, newTime, tagValue);
  } else {
  ...
  (function checkDislay() {
    if (_domElements__WEBPACK_IMPORTED_MODULE_0__.allProjects.length !== 0) {
      projectBtn.addEventListener("click", e => {
        ...
        (0,_displayOnly__WEBPACK_IMPORTED_MODULE_2__["default"])(thisProject.name, thisProject.description, thisProject.priority, thisProject.dueDate, thisProject.time);
...
function loadProjects(projects) {
  for (let i = 0; i < projects.length; i += 1) {
    const id = i + 1;
    (0,_createProject__WEBPACK_IMPORTED_MODULE_0__.getProjects)(projects[i].name, projects[i].description, projects[i].priority, projects[i].dueDate, projects[i].time, projects[i].tags, projects[i].done);
...
function updateProjectInfo(index) {
  ...
  if (_domElements__WEBPACK_IMPORTED_MODULE_0__.low.checked) {
    ...
    document.getElementById(`priority${index}`).style.backgroundColor = "yellow";
  } else if (_domElements__WEBPACK_IMPORTED_MODULE_0__.high.checked) {
...
function welcome() {
  ...
  switch (true) {
    case currentHour >= 20 || currentHour < 6:
      ...
      _domElements__WEBPACK_IMPORTED_MODULE_0__.contentTop.style.backgroundImage = "linear-gradient(rgb(51, 41, 41), rgb(0, 34, 128))";
    ...
    case currentHour >= 6 && currentHour < 12:
      ...
      _domElements__WEBPACK_IMPORTED_MODULE_0__.contentTop.style.backgroundImage = "linear-gradient(rgb(6, 132, 235), rgb(255, 255, 255))";
      console.log("sunrise");
      break;
    case currentHour >= 12 && currentHour < 19:
      ...
      _domElements__WEBPACK_IMPORTED_MODULE_0__.contentTop.style.backgroundImage = "linear-gradient(rgb(255, 174, 0), rgb(2, 175, 255))";
      console.log("sun");
      break;
